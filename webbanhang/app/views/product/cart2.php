                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">                                
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php $total = 0; // Biến lưu tổng giá trị giỏ hàng
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="/webbanhang/Product/updateCartQuantity/<?php echo $item['product_id']; ?>" method="post" class="d-inline">
                                                ...
                                                <td>
                                                    <a href="/webbanhang/Product/removeFromCart/<?php echo $item['product_id']; ?>"><i class="ri-delete-bin-7-fill"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
